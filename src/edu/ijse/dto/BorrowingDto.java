...
public class BorrowingDto {
    ...
    public BorrowingDto(String borrowing_id, String book_id, String member_id, String borrow_date, String due_date, String return_date) {
    ...
    public String toString() {
        return "BorrowingDto{" + "borrowing_id=" + borrowing_id + ", book_id=" + book_id + ", member_id=" + member_id + ", borrow_date=" + borrow_date + ", due_date=" + due_date + ", return_date=" + return_date + '}';
    }
